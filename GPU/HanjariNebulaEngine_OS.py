# -*- coding: utf-8 -*-
"""
HanjariNebulaEngine_OS (Open-Source / OpenMM Edition - GPU Accelerated)
----------------------------------------------------------------------
...
class HanjariNebulaEngine_OS:
    ...
    def minimize_structure(self, input_path, output_path):
        ...
        print("  扫 [NebulaGuard] Sanitizing topology and rebuilding representation...")
